        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center">
              ...
              <span className="text-xl font-outfit font-semibold text-citysense-text-primary">
                CitySense
              </span>
            </Link>
            <p className="mt-4 text-sm text-citysense-text-secondary">
              Smart urban monitoring for a better city experience. Real-time
              insights for urban challenges.
            </p>
          </div>

          <div className="col-span-1">
            <h3 className="text-sm font-semibold text-citysense-text-primary tracking-wider uppercase">
              Navigation
            </h3>
            <ul className="mt-4 space-y-2">
              <li>
                <Link
                  to="/"
                  className="text-sm text-citysense-text-secondary hover:text-citysense-green transition-colors"
                >
                  Home
                </Link>
              </li>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-sm text-citysense-text-secondary">
