        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-1/2 lg:pr-12 mb-10 lg:mb-0">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Smart Urban{" "}
              <span className="text-citysense-green">Monitoring</span>
            </h1>

            <p className="text-lg text-citysense-text-secondary mb-8 max-w-lg opacity-0 animate-fade-in-delay-1">
              CitySense uses IoT and AI to monitor urban problems like air
              pollution, potholes, hygiene issues, and waterlogging in
              real-time.
            </p>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 opacity-0 animate-fade-in-delay-2">
              ...
              <Button
                variant="outline"
                className="border-citysense-green text-citysense-green hover:bg-citysense-green/10"
              >
                View Live Map
              </Button>
            </div>
          ...
          <div className="w-full lg:w-1/2 relative opacity-0 animate-fade-in-delay-2">
            ...
            <svg
              className="w-full cityscape-anim"
              viewBox="0 0 800 500"
              fill="none"
            ...
            >
              {/* City Skyline */}
              <path
                d="M50,350 L50,250 L100,250 L100,200 L150,200 L150,250 L200,250 L200,150 L250,150 L250,250 L300,250 L300,200 L350,200 L350,100 L400,100 L400,200 L450,200 L450,250 L500,250 L500,150 L550,150 L550,250 L600,250 L600,200 L650,200 L650,300 L700,300 L700,350"
                stroke="#4E9F3D"
                strokeWidth="2"
                fill="none"
              />
              ...
              <path
                d="M150,150 Q225,50 300,180"
                stroke="#4E9F3D"
                strokeWidth="1"
                strokeDasharray="2, 2"
              />
              <path
                d="M300,180 Q375,100 450,230"
                stroke="#3ABEFF"
                strokeWidth="1"
                strokeDasharray="2, 2"
              />
              <path
                d="M450,230 Q525,150 600,200"
                stroke="#FF6B6B"
                strokeWidth="1"
                strokeDasharray="2, 2"
              />
