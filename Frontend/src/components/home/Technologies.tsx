      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-citysense-text-secondary max-w-2xl mx-auto">
            CitySense leverages cutting-edge technologies to deliver accurate,
            real-time monitoring and insights for urban environments.
          </p>
        </div>
          ...
          <div className="inline-flex space-x-8 px-4">
            {technologies.map((tech, index) => (
              ...
              >
                ...
                <p className="text-sm text-citysense-text-secondary text-center whitespace-normal">
                  {tech.description}
                </p>
              </div>
            ))}
